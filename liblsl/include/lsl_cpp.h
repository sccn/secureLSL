...
public:
	 ...
	 *
	 * When security is enabled, all data transmitted on this stream is encrypted
	 ...
	 *
	 * The fingerprint is a BLAKE2b hash of the device's Ed25519 public key,
	 * formatted as "BLAKE2b:xxxx...". This can be used to verify device identity.
	 *
	 * @return The fingerprint string, or empty string if security is not enabled.
	 */
