 ...
 *
 * @param info The streaminfo object to query.
 * @return 1 if security is enabled, 0 if not, -1 on error.
 */
 ...
 *
 * @param info The streaminfo object to query.
 * @return An immutable library-owned pointer to the fingerprint string,
 *         or an empty string if security is not enabled.
 */
