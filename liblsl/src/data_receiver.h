...
#ifdef LSL_SECURITY_ENABLED
	// Security state for this connection
	/// whether security is enabled for this connection
	bool security_enabled_{false};
	/// session state containing keys and nonce tracking
	std::unique_ptr<security::SessionState> session_state_;
#endif
};
