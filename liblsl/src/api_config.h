...
public:
	...
	/**
	 * @brief Whether security is enabled for this device
	 * @return true if security credentials are loaded and enabled
	 */
	bool security_enabled() const { return security_enabled_; }

	/**
	 * @brief Session key lifetime in seconds
	 * @return Lifetime before key rotation (default 3600)
	 */
	uint32_t security_session_key_lifetime() const { return security_session_key_lifetime_; }
#endif
...
private:
	...
	uint32_t security_session_key_lifetime_;
#endif
};
} // namespace lsl
